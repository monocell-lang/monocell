...
auto user = { "AB8501156421", "Asia-01", true };
// Type: [str, str, bool]
...
[[str, str, int], 
 ...
 [bool, [str, str], [str, str, str, str]]
   ...
   { "Arthur", "Pendragon", 472 },
   { "Igraine", "Uther" },
   { 
     true, 
     { "Guinevere", "Lionor" },
     { "Amir", "Lohot", "Gawain", "Mordred" }
   }
};

```
  
Example 4: composite with only 1 element  
```
...
tup = { 321, "Go!🐎" };            //✅
tup = { 12.34, 7749, "what" };     //❌Wrong type!
...
Example 1:  
```
[str title, str author, int year, int pages] book = { "Moby Dick", "Herman Melville", 1851, 822 };
