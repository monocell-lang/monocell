...
Example 9: use reference to avoid copy or move  
```
struct String {
   (Example 4)
...
Example 10: composite / struct field are references. surprised😵‍💫🤡?  
```
struct Person {
   String name,
   short age,
...
Example 11: a field of a value is also a value  
```
struct Person {
   String name,
   short age,
